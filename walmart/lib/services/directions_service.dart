...
class DirectionsService {
  ...
  /// Get directions including waypoints (ChampionLocation)
  static Future<List<LatLng>> getDirectionsWithChampionWaypoints(
    LocationPoint start,
    ...
    try {
      ...
      print('Error in getDirectionsWithChampionWaypoints: $e');
      return getDirections(start, end);
    }
    return [];
  }

  /// Fallback route: Straight line between two points
  static List<LatLng> getStraightLineRoute(LocationPoint start, LocationPoint end) {
    return [
      LatLng(start.latitude, start.longitude),
      LatLng(end.latitude, end.longitude),
  ...
  /// Fallback route with multiple straight-line points (ChampionLocation)
  static List<LatLng> getStraightLineRouteWithChampionWaypoints(
    LocationPoint start,
    List<ChampionLocation> waypoints,
    LocationPoint end,
  ) {
  ...
  /// Get route metadata (distance, duration)
  static Future<Map<String, dynamic>?> getRouteInfo(
    LocationPoint start,
    LocationPoint end,
  ) async {
