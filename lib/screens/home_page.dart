...
// // //               Text(
// // //                 "You chose: ${_selectedDate!.day}/${_selectedDate!.month}/${_selectedDate!.year}",
...
// // //               Text(
// // //                 "Cutoff: ${_cutoffDate!.day}/${_cutoffDate!.month}/${_cutoffDate!.year} at ${_cutoffDate!.hour.toString().padLeft(2, '0')}:${_cutoffDate!.minute.toString().padLeft(2, '0')}",
...
// //   // Dummy community list
// //   final List<String> _communityMembers = [
// //     'Alice Johnson',
// //     'Bob Smith',
// //     'Charlie Davis',
// //     'Dana Lee',
...
// //             title: Text(_communityMembers[index]),
// //             subtitle: const Text('Champion member'),
// //             onTap: () {
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void _openScanner() {
    ...
    // This is where you would integrate with a barcode/QR scanner package
    showDialog(
      context: context,
